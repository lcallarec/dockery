...
TSOURCES:=$(shell find src/ -name *.vala |grep -v "main.vala" |grep -v "App.vala"  |grep -v "ApplicationListener.vala" |grep -v "MainContainer.vala" |grep -v "StackHubListener.vala")
...
TCSOURCES=$(shell find src/ tests/ -name '*.c' |grep -v "main.c" |grep -v "App.c" |grep -v "ApplicationListener.c" |grep -v "MainContainer.c" |grep -v "StackHubListener.c")
