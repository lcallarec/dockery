namespace Dockery.DockerSdk.Endpoint {
    ...
    public class ContainerEndpoint : Endpoint {
         ...
         */
        public void pause(Model.Container container) throws RequestError {
         ...
         */
        public void unpause(Model.Container container) throws RequestError {
         ...
         */
        public void restart(Model.Container container) throws RequestError {
            ...
            try {
                ...
                throw new RequestError.FATAL("Error while restarting container %s : %s".printf(container.id, e.message));
            }
        }
         ...
         */
        public void remove(Model.Container container, bool force = false) throws RequestError {
         ...
         */
        public void start(Model.Container container) throws RequestError {
         ...
         */
        public void stop(Model.Container container) throws RequestError {
         ...
         */
        public void kill(Model.Container container) throws RequestError {
         ...
         */
        public void rename(Model.Container container) throws RequestError {
         ...
         * See [[https://docs.docker.com/engine/reference/api/docker_remote_api_v1.21/#list-containers]]
         */
        public Model.ContainerCollection find_by_image(Model.Image image) throws RequestError {
            ...
            try {
                ...
                throw new RequestError.FATAL("Error while fetching containers by image (%s)".printf(e.message));
            }
        }
         ...
         * See [[https://docs.docker.com/engine/reference/api/docker_remote_api_v1.21/#list-containers]]
         */
        public Model.ContainerCollection find_by_images(Model.ImageCollection images) throws RequestError {
            ...
            try {
                ...
                throw new RequestError.FATAL("Error while fetching containers for images [%s](%s)".printf(string.join(", ", containers.get_ids()), e.message));
            }
         ...
         */
        public void create(Model.ContainerCreate container_create) throws RequestError {
            ...
            try {
                ...
                throw new RequestError.FATAL("Error while creating container from image %s".printf(container_create.image.id));
            }
        }
         ...
         */
        public string inspect(Model.Container container) throws RequestError {
            ...
            try {
                ...
                throw new RequestError.FATAL("Error while inspecting container %s".printf(container.id));
            }
        }
         ...
         */
        public Io.FutureResponse<Model.ContainerStat> stats(Model.Container container) throws RequestError {
            ...
            try {
                ...
                throw new RequestError.FATAL("Error while getting stats of container %s".printf(container.id));
            }
        }
