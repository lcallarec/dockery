namespace View.Docker.Dialog {
    ...
    public class RemoveImageDialog : View.Dialog {
        ...
        public RemoveImageDialog(Sdk.Docker.Model.Containers linked_containers, Sdk.Docker.Model.Image image, Gtk.Window parent) {
            ...
            int number_of_linked_containers = linked_containers.length;
            ...
            if (number_of_linked_containers == 0) {
                ...
                Gtk.Label text = new Gtk.Label("This image is linked to %d containers. Removing the image will also destroy these containers :".printf(linked_containers.length));
        ...
        private void populate_liststore_from_containers(Sdk.Docker.Model.Containers linked_containers) {
